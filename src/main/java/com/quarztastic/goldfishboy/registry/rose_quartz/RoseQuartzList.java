...
public class RoseQuartzList {
    ...
    public static DeferredBlock<RoseQuartzGrindstone> ROSE_QUARTZ_GRINDSTONE;
    public static DeferredItem<BlockItem> ROSE_QUARTZ_GRINDSTONE_ITEM;
    ...
    public static DeferredBlock<Statuette> ROSE_QUARTZ_GOLDFISH_STATUETTE;
    public static DeferredItem<BlockItem> ROSE_QUARTZ_GOLDFISH_STATUETTE_ITEM;

    public static DeferredBlock<Statuette> ROSE_QUARTZ_CHICKEN_STATUETTE;
    public static DeferredItem<BlockItem> ROSE_QUARTZ_CHICKEN_STATUETTE_ITEM;

    public static DeferredBlock<Statuette> ROSE_QUARTZ_BEE_STATUETTE;
    public static DeferredItem<BlockItem> ROSE_QUARTZ_BEE_STATUETTE_ITEM;
