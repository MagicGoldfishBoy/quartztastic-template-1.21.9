...
public class BlueQuartzStonecutterMenu extends AbstractContainerMenu {
    ...
    public final Container container = new SimpleContainer(1) {
        ...
        public void setChanged() {
            super.setChanged();
            BlueQuartzStonecutterMenu.this.slotsChanged(this);
            BlueQuartzStonecutterMenu.this.slotUpdateListener.run();
        }
    };
    /**
    ...
    public BlueQuartzStonecutterMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, ContainerLevelAccess.NULL);
    }

    public BlueQuartzStonecutterMenu(int containerId, Inventory playerInventory, final ContainerLevelAccess access) {
    ...
    public boolean stillValid(Player player) {
        return stillValid(this.access, player, BlueQuartzList.BLUE_QUARTZ_STONECUTTER.get());
    }
