...
public class NetherQuartzStonecutterMenu extends AbstractContainerMenu {
    ...
    public final Container container = new SimpleContainer(1) {
        ...
        public void setChanged() {
            super.setChanged();
            NetherQuartzStonecutterMenu.this.slotsChanged(this);
            NetherQuartzStonecutterMenu.this.slotUpdateListener.run();
        }
    };
    /**
    ...
    public NetherQuartzStonecutterMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, ContainerLevelAccess.NULL);
    }

    public NetherQuartzStonecutterMenu(int containerId, Inventory playerInventory, final ContainerLevelAccess access) {
        ...
        this.resultSlot = this.addSlot(new Slot(this.resultContainer, 1, 143, 33) {
            ...
            public void onTake(Player player, ItemStack stack) {
                ...
                NetherQuartzStonecutterMenu.this.resultContainer.awardUsedRecipes(player, this.getRelevantItems());
                ItemStack itemstack = NetherQuartzStonecutterMenu.this.inputSlot.remove(1);
                if (!itemstack.isEmpty()) {
                    NetherQuartzStonecutterMenu.this.setupResultSlot(NetherQuartzStonecutterMenu.this.selectedRecipeIndex.get());
                }

                access.execute((Level, blockPos) -> {
                    long i = Level.getGameTime();
                    if (NetherQuartzStonecutterMenu.this.lastSoundTime != i) {
                        Level.playSound(null, blockPos, SoundEvents.UI_STONECUTTER_TAKE_RESULT, SoundSource.BLOCKS, 1.0F, 1.0F);
                        NetherQuartzStonecutterMenu.this.lastSoundTime = i;
                    }
            ...
            private List<ItemStack> getRelevantItems() {
                return List.of(NetherQuartzStonecutterMenu.this.inputSlot.getItem());
            }
        });
