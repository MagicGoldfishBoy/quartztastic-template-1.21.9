...
public class RoseQuartzStonecutterMenu extends AbstractContainerMenu {
    ...
    public final Container container = new SimpleContainer(1) {
        ...
        public void setChanged() {
            super.setChanged();
            RoseQuartzStonecutterMenu.this.slotsChanged(this);
            RoseQuartzStonecutterMenu.this.slotUpdateListener.run();
        }
    };
    /**
    ...
    public RoseQuartzStonecutterMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, ContainerLevelAccess.NULL);
    }

    public RoseQuartzStonecutterMenu(int containerId, Inventory playerInventory, final ContainerLevelAccess access) {
        ...
        this.resultSlot = this.addSlot(new Slot(this.resultContainer, 1, 143, 33) {
            ...
            private List<ItemStack> getRelevantItems() {
                return List.of(RoseQuartzStonecutterMenu.this.inputSlot.getItem());
            }
        });
    ...
    public boolean stillValid(Player player) {
        return stillValid(this.access, player, RoseQuartzList.ROSE_QUARTZ_STONECUTTER.get());
    }
