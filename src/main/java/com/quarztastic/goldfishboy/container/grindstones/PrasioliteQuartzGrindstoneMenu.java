...
public class PrasioliteQuartzGrindstoneMenu extends AbstractContainerMenu {
    ...
    final Container repairSlots = new SimpleContainer(2) {
        ...
        public void setChanged() {
            super.setChanged();
            PrasioliteQuartzGrindstoneMenu.this.slotsChanged(this);
        }
    };
    private final ContainerLevelAccess access;
    private int xp = -1;

    public PrasioliteQuartzGrindstoneMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, ContainerLevelAccess.NULL);
    }

    public PrasioliteQuartzGrindstoneMenu(int containerId, Inventory playerInventory, final ContainerLevelAccess access) {
        ...
        this.addSlot(new Slot(this.resultSlots, 2, 129, 34) {
            ...
            public void onTake(Player player, ItemStack stack) {
                if (net.neoforged.neoforge.common.CommonHooks.onGrindstoneTake(PrasioliteQuartzGrindstoneMenu.this.repairSlots, access, player, this::getExperienceAmount)) return;
                ...
                PrasioliteQuartzGrindstoneMenu.this.repairSlots.setItem(0, ItemStack.EMPTY);
                PrasioliteQuartzGrindstoneMenu.this.repairSlots.setItem(1, ItemStack.EMPTY);
            }
            ...
            private int getExperienceAmount(Level level) {
                if (xp > -1) return xp;
                int i = 0;
                i += this.getExperienceFromItem(PrasioliteQuartzGrindstoneMenu.this.repairSlots.getItem(0));
                i += this.getExperienceFromItem(PrasioliteQuartzGrindstoneMenu.this.repairSlots.getItem(1));
                if (i > 0) {
    ...
    public boolean stillValid(Player player) {
        return stillValid(this.access, player, PrasioliteQuartzList.PRASIOLITE_QUARTZ_GRINDSTONE.get());
    }
