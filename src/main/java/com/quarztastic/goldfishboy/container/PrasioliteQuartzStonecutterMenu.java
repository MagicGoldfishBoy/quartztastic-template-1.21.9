...
public class PrasioliteQuartzStonecutterMenu extends AbstractContainerMenu {
    ...
    public final Container container = new SimpleContainer(1) {
        ...
        public void setChanged() {
            super.setChanged();
            PrasioliteQuartzStonecutterMenu.this.slotsChanged(this);
            PrasioliteQuartzStonecutterMenu.this.slotUpdateListener.run();
        }
    };
    /**
    ...
    public PrasioliteQuartzStonecutterMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, ContainerLevelAccess.NULL);
    }

    public PrasioliteQuartzStonecutterMenu(int containerId, Inventory playerInventory, final ContainerLevelAccess access) {
        ...
        this.resultSlot = this.addSlot(new Slot(this.resultContainer, 1, 143, 33) {
            ...
            public void onTake(Player player, ItemStack stack) {
                ...
                PrasioliteQuartzStonecutterMenu.this.resultContainer.awardUsedRecipes(player, this.getRelevantItems());
                ItemStack itemstack = PrasioliteQuartzStonecutterMenu.this.inputSlot.remove(1);
                if (!itemstack.isEmpty()) {
                    PrasioliteQuartzStonecutterMenu.this.setupResultSlot(PrasioliteQuartzStonecutterMenu.this.selectedRecipeIndex.get());
                }

                access.execute((Level, blockPos) -> {
                    long i = Level.getGameTime();
                    if (PrasioliteQuartzStonecutterMenu.this.lastSoundTime != i) {
                        Level.playSound(null, blockPos, SoundEvents.UI_STONECUTTER_TAKE_RESULT, SoundSource.BLOCKS, 1.0F, 1.0F);
                        PrasioliteQuartzStonecutterMenu.this.lastSoundTime = i;
                    }
            ...
            private List<ItemStack> getRelevantItems() {
                return List.of(PrasioliteQuartzStonecutterMenu.this.inputSlot.getItem());
            }
        });
    ...
    public boolean stillValid(Player player) {
        return stillValid(this.access, player, PrasioliteQuartzList.PRASIOLITE_QUARTZ_STONECUTTER.get());
    }
