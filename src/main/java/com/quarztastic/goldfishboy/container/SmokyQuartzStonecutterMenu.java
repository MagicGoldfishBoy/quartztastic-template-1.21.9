...
public class SmokyQuartzStonecutterMenu extends AbstractContainerMenu {
    ...
    public final Container container = new SimpleContainer(1) {
        ...
        public void setChanged() {
            super.setChanged();
            SmokyQuartzStonecutterMenu.this.slotsChanged(this);
            SmokyQuartzStonecutterMenu.this.slotUpdateListener.run();
        }
    };
    /**
    ...
    public SmokyQuartzStonecutterMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, ContainerLevelAccess.NULL);
    }

    public SmokyQuartzStonecutterMenu(int containerId, Inventory playerInventory, final ContainerLevelAccess access) {
        ...
        this.resultSlot = this.addSlot(new Slot(this.resultContainer, 1, 143, 33) {
            ...
            private List<ItemStack> getRelevantItems() {
                return List.of(SmokyQuartzStonecutterMenu.this.inputSlot.getItem());
            }
        });
    ...
    public boolean stillValid(Player player) {
        return stillValid(this.access, player, SmokyQuartzList.SMOKY_QUARTZ_STONECUTTER.get());
    }
