...
public class QuartztasticClient {
    ...
    static void setSmokyQuartzRenderLayers() {
        ...
        ItemBlockRenderTypes.setRenderLayer(SmokyQuartzList.SMOKY_QUARTZ_STONECUTTER.get(), ChunkSectionLayer.TRANSLUCENT);
        ItemBlockRenderTypes.setRenderLayer(SmokyQuartzList.SMOKY_QUARTZ_GRINDSTONE.get(), ChunkSectionLayer.TRANSLUCENT);
        ...
        ItemBlockRenderTypes.setRenderLayer(SmokyQuartzList.SMOKY_QUARTZ_GOLDFISH_STATUETTE.get(), ChunkSectionLayer.TRANSLUCENT);
        ItemBlockRenderTypes.setRenderLayer(SmokyQuartzList.SMOKY_QUARTZ_CHICKEN_STATUETTE.get(), ChunkSectionLayer.TRANSLUCENT);
        ItemBlockRenderTypes.setRenderLayer(SmokyQuartzList.SMOKY_QUARTZ_BEE_STATUETTE.get(), ChunkSectionLayer.TRANSLUCENT);
        ItemBlockRenderTypes.setRenderLayer(SmokyQuartzList.SMOKY_QUARTZ_FROG_STATUETTE.get(), ChunkSectionLayer.TRANSLUCENT);
        ItemBlockRenderTypes.setRenderLayer(SmokyQuartzList.SMOKY_QUARTZ_AXOLOTL_STATUETTE.get(), ChunkSectionLayer.TRANSLUCENT);
    ...
    static void setCitrineRenderLayers() {
        ...
        ItemBlockRenderTypes.setRenderLayer(CitrineList.CITRINE_STONECUTTER.get(), ChunkSectionLayer.TRANSLUCENT);
        ItemBlockRenderTypes.setRenderLayer(CitrineList.CITRINE_GRINDSTONE.get(), ChunkSectionLayer.TRANSLUCENT);
        ...
        ItemBlockRenderTypes.setRenderLayer(CitrineList.CITRINE_GOLDFISH_STATUETTE.get(), ChunkSectionLayer.TRANSLUCENT);
    ...
    static void setBlueQuartzRenderLayers() {
        ...
        ItemBlockRenderTypes.setRenderLayer(BlueQuartzList.BLUE_QUARTZ_GOLDFISH_STATUETTE.get(), ChunkSectionLayer.TRANSLUCENT);
    ...
    static void setPrasioliteQuartzRenderLayers(FMLClientSetupEvent event) {
        ...
        ItemBlockRenderTypes.setRenderLayer(PrasioliteQuartzList.PRASIOLITE_QUARTZ_CRAFTING_TABLE.get(), ChunkSectionLayer.TRANSLUCENT);
        ItemBlockRenderTypes.setRenderLayer(PrasioliteQuartzList.PRASIOLITE_QUARTZ_STONECUTTER.get(), ChunkSectionLayer.TRANSLUCENT);
        ItemBlockRenderTypes.setRenderLayer(PrasioliteQuartzList.PRASIOLITE_QUARTZ_GRINDSTONE.get(), ChunkSectionLayer.TRANSLUCENT);
        ...
        ItemBlockRenderTypes.setRenderLayer(PrasioliteQuartzList.PRASIOLITE_QUARTZ_CHICKEN_STATUETTE.get(), ChunkSectionLayer.TRANSLUCENT);
        ItemBlockRenderTypes.setRenderLayer(PrasioliteQuartzList.PRASIOLITE_QUARTZ_BEE_STATUETTE.get(), ChunkSectionLayer.TRANSLUCENT);
        ItemBlockRenderTypes.setRenderLayer(PrasioliteQuartzList.PRASIOLITE_QUARTZ_FROG_STATUETTE.get(), ChunkSectionLayer.TRANSLUCENT);
        ItemBlockRenderTypes.setRenderLayer(PrasioliteQuartzList.PRASIOLITE_QUARTZ_AXOLOTL_STATUETTE.get(), ChunkSectionLayer.TRANSLUCENT);
