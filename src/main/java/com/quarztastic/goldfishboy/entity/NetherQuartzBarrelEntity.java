...
public class NetherQuartzBarrelEntity extends RandomizableContainerBlockEntity {
    private static final Component DEFAULT_NAME = Component.translatable("container.nether_quartz_barrel");
    ...
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        ...
        protected void onOpen(Level p_155062_, BlockPos p_155063_, BlockState p_155064_) {
            NetherQuartzBarrelEntity.this.playSound(p_155064_, SoundEvents.AMETHYST_BLOCK_BREAK);
            NetherQuartzBarrelEntity.this.updateBlockState(p_155064_, true);
        }

        @SuppressWarnings("null")
        @Override
        protected void onClose(Level p_155072_, BlockPos p_155073_, BlockState p_155074_) {
            NetherQuartzBarrelEntity.this.playSound(p_155074_, SoundEvents.AMETHYST_BLOCK_BREAK);
            NetherQuartzBarrelEntity.this.updateBlockState(p_155074_, false);
        }
        ...
        public boolean isOwnContainer(Player p_155060_) {
            if (p_155060_.containerMenu instanceof ChestMenu) {
                ...
                return container == NetherQuartzBarrelEntity.this;
            } else {
                return false;
            }
        }
    ...
    public NetherQuartzBarrelEntity(BlockPos pos, BlockState blockState) {
        super(NetherQuartzFurnitureBlockList.NETHER_QUARTZ_BARREL_ENTITY.get(), pos, blockState);
    }
