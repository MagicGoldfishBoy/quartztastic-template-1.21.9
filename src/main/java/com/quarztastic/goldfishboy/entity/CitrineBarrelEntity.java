...
public class CitrineBarrelEntity extends RandomizableContainerBlockEntity {
    private static final Component DEFAULT_NAME = Component.translatable("container.citrine_barrel");
    ...
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        ...
        protected void onOpen(Level p_155062_, BlockPos p_155063_, BlockState p_155064_) {
            CitrineBarrelEntity.this.playSound(p_155064_, SoundEvents.AMETHYST_BLOCK_BREAK);
            CitrineBarrelEntity.this.updateBlockState(p_155064_, true);
        }

        @SuppressWarnings("null")
        @Override
        protected void onClose(Level p_155072_, BlockPos p_155073_, BlockState p_155074_) {
            CitrineBarrelEntity.this.playSound(p_155074_, SoundEvents.AMETHYST_BLOCK_BREAK);
            CitrineBarrelEntity.this.updateBlockState(p_155074_, false);
        }
        ...
        public boolean isOwnContainer(Player p_155060_) {
            if (p_155060_.containerMenu instanceof ChestMenu) {
                ...
                return container == CitrineBarrelEntity.this;
            } else {
                return false;
            }
        }
    ...
    public CitrineBarrelEntity(BlockPos pos, BlockState blockState) {
        super(CitrineList.CITRINE_BARREL_ENTITY.get(), pos, blockState);
    }
