...
public class CitrineNightstandEntity extends RandomizableContainerBlockEntity {
    private static final Component DEFAULT_NAME = Component.translatable("container.citrine_nightstand");
    private NonNullList<ItemStack> items = NonNullList.withSize(18, ItemStack.EMPTY);
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        @SuppressWarnings("null")
        @Override
        protected void onOpen(Level p_155062_, BlockPos p_155063_, BlockState p_155064_) {
            CitrineNightstandEntity.this.playSound(p_155064_, SoundEvents.AMETHYST_BLOCK_BREAK);
            CitrineNightstandEntity.this.updateBlockState(p_155064_, true);
        }

        @SuppressWarnings("null")
        @Override
        protected void onClose(Level p_155072_, BlockPos p_155073_, BlockState p_155074_) {
            CitrineNightstandEntity.this.playSound(p_155074_, SoundEvents.AMETHYST_BLOCK_BREAK);
            CitrineNightstandEntity.this.updateBlockState(p_155074_, false);
        }
        ...
        public boolean isOwnContainer(Player p_155060_) {
            if (p_155060_.containerMenu instanceof ChestMenu) {
                ...
                return container == CitrineNightstandEntity.this;
            } else {
                return false;
            }
        }
    ...
    public CitrineNightstandEntity(BlockPos pos, BlockState blockState) {
        super(CitrineList.CITRINE_NIGHTSTAND_ENTITY.get(), pos, blockState);
    }
    ...
    void updateBlockState(BlockState state, boolean open) {
        this.level.setBlock(this.getBlockPos(), state.setValue(CitrineNightstand.OPEN, open), 3);
    }

    @SuppressWarnings("null")
    void playSound(BlockState state, SoundEvent sound) {
        Vec3i vec3i = state.getValue(CitrineNightstand.FACING).getUnitVec3i();
