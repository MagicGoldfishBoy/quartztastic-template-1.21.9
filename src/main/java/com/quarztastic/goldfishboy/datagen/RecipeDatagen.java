...
public class RecipeDatagen extends RecipeProvider {
    ...
    protected void buildBlockRecipes() {
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(Items.QUARTZ_BLOCK), RecipeCategory.BUILDING_BLOCKS, NetherQuartzBasicBlockList.NETHER_QUARTZ_TILES.get())
            .unlockedBy("has_quartz_block", has(Items.QUARTZ_BLOCK))
            .save(this.output);


        ShapedRecipeBuilder.shaped(this.registries.lookupOrThrow(Registries.ITEM), RecipeCategory.BUILDING_BLOCKS, NetherQuartzBasicBlockList.NETHER_QUARTZ_BARS_ITEM.get(), 18)
            .pattern("@@@")
            .pattern("@@@")
            .define('@', Items.QUARTZ)
        ...
        ShapedRecipeBuilder.shaped(this.registries.lookupOrThrow(Registries.ITEM), RecipeCategory.BUILDING_BLOCKS, NetherQuartzBasicBlockList.NETHER_QUARTZ_BARS_BLOCK_ITEM.get())
            .pattern("@@@")
            .pattern("@@@")
            .pattern("@@@")
            .define('@', NetherQuartzBasicBlockList.NETHER_QUARTZ_BARS_ITEM.get())
            .unlockedBy("has_nether_quartz_bars", has(NetherQuartzBasicBlockList.NETHER_QUARTZ_BARS_ITEM.get()))
            .save(this.output);
        ...
        ShapedRecipeBuilder.shaped(this.registries.lookupOrThrow(Registries.ITEM), RecipeCategory.BUILDING_BLOCKS, BlueQuartzList.BLUE_QUARTZ_GRINDSTONE_ITEM.get())
            .pattern("@@@")
            .pattern("@#@")
            .pattern("@@@")
            .define('@', BlueQuartzList.BLUE_QUARTZ_CRYSTAL.get())
        ...
        ShapedRecipeBuilder.shaped(this.registries.lookupOrThrow(Registries.ITEM), RecipeCategory.BUILDING_BLOCKS, PrasioliteQuartzList.PRASIOLITE_QUARTZ_GRINDSTONE_ITEM.get())
            .pattern("@@@")
            .pattern("@#@")
            .pattern("@@@")
            .define('@', PrasioliteQuartzList.PRASIOLITE_QUARTZ_CRYSTAL.get())
    ...
    protected void buildSlabRecipes() {
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(NetherQuartzBasicBlockList.NETHER_QUARTZ_TILES.get()), RecipeCategory.BUILDING_BLOCKS, NetherQuartzBasicBlockList.NETHER_QUARTZ_TILE_SLAB.get(), 2)
            .unlockedBy("has_nether_quartz_tiles", has(NetherQuartzBasicBlockList.NETHER_QUARTZ_TILES.get()))
            .save(this.output, "nether_quartz_tiles_slab_by_stonecutting");

        ShapedRecipeBuilder.shaped(this.registries.lookupOrThrow(Registries.ITEM), RecipeCategory.BUILDING_BLOCKS, NetherQuartzBasicBlockList.NETHER_QUARTZ_TILE_SLAB.get(), 6)
            .pattern("@@@")
            .define('@', NetherQuartzBasicBlockList.NETHER_QUARTZ_TILES.get())
            .unlockedBy("has_nether_quartz_tiles", has(NetherQuartzBasicBlockList.NETHER_QUARTZ_TILES.get()))
            .save(this.output, "nether_quartz_tiles_slab_by_crafting");
    ...
    protected void buildStairsRecipes() {
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(NetherQuartzBasicBlockList.NETHER_QUARTZ_TILES.get()), RecipeCategory.BUILDING_BLOCKS, NetherQuartzBasicBlockList.NETHER_QUARTZ_TILE_STAIRS.get())
            .unlockedBy("has_nether_quartz_tiles", has(NetherQuartzBasicBlockList.NETHER_QUARTZ_TILES.get()))
            .save(this.output, "nether_quartz_tiles_stairs_by_stonecutting");

        ShapedRecipeBuilder.shaped(this.registries.lookupOrThrow(Registries.ITEM), RecipeCategory.BUILDING_BLOCKS, NetherQuartzBasicBlockList.NETHER_QUARTZ_TILE_STAIRS.get(), 4)
            .pattern("@  ")
            .pattern("@@ ")
            .pattern("@@@")
            .define('@', NetherQuartzBasicBlockList.NETHER_QUARTZ_TILES.get())
            .unlockedBy("has_nether_quartz_tiles", has(NetherQuartzBasicBlockList.NETHER_QUARTZ_TILES.get()))
            .save(this.output, "nether_quartz_tiles_stairs_by_crafting");
    ...
    protected void buildTableRecipes() {
        ...
        ShapedRecipeBuilder.shaped(this.registries.lookupOrThrow(Registries.ITEM), RecipeCategory.DECORATIONS, NetherQuartzFurnitureBlockList.NETHER_QUARTZ_TABLE_ITEM.get(), 2)
            .pattern("###")
            .pattern("@ @")
            .define('@', Items.QUARTZ)
            .define('#', Items.QUARTZ_SLAB)
    ...
    protected void buildShelfRecipes() {
        ...
        ShapedRecipeBuilder.shaped(this.registries.lookupOrThrow(Registries.ITEM), RecipeCategory.DECORATIONS, NetherQuartzFurnitureBlockList.NETHER_QUARTZ_SHELF_ITEM.get(), 2)
            .pattern("###")
            .pattern("  @")
            .define('@', Items.QUARTZ)
            .define('#', Items.QUARTZ_SLAB)
    ...
    protected void buildContainerRecipes() {
        ...
        ShapedRecipeBuilder.shaped(this.registries.lookupOrThrow(Registries.ITEM), RecipeCategory.BUILDING_BLOCKS, NetherQuartzFurnitureBlockList.NETHER_QUARTZ_NIGHTSTAND_ITEM.get(), 2)
            .pattern("###")
            .pattern("@$@")
            .pattern("@@@")
            .define('@', Items.QUARTZ_BLOCK)
    ...
    protected void buildStatueRecipes() {
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(SmokyQuartzList.SMOKY_QUARTZ_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, SmokyQuartzList.SMOKY_QUARTZ_CHICKEN_STATUETTE_ITEM.get())
            .unlockedBy("has_smoky_quartz_block", has(SmokyQuartzList.SMOKY_QUARTZ_BLOCK_ITEM.get()))
            .save(this.output, "smoky_quartz_chicken_statuette_by_stonecutting");

        SingleItemRecipeBuilder.stonecutting(Ingredient.of(SmokyQuartzList.SMOKY_QUARTZ_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, SmokyQuartzList.SMOKY_QUARTZ_BEE_STATUETTE_ITEM.get())
            .unlockedBy("has_smoky_quartz_block", has(SmokyQuartzList.SMOKY_QUARTZ_BLOCK_ITEM.get()))
            .save(this.output, "smoky_quartz_bee_statuette_by_stonecutting");

        SingleItemRecipeBuilder.stonecutting(Ingredient.of(SmokyQuartzList.SMOKY_QUARTZ_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, SmokyQuartzList.SMOKY_QUARTZ_FROG_STATUETTE_ITEM.get())
            .unlockedBy("has_smoky_quartz_block", has(SmokyQuartzList.SMOKY_QUARTZ_BLOCK_ITEM.get()))
            .save(this.output, "smoky_quartz_frog_statuette_by_stonecutting");

        SingleItemRecipeBuilder.stonecutting(Ingredient.of(SmokyQuartzList.SMOKY_QUARTZ_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, SmokyQuartzList.SMOKY_QUARTZ_AXOLOTL_STATUETTE_ITEM.get())
            .unlockedBy("has_smoky_quartz_block", has(SmokyQuartzList.SMOKY_QUARTZ_BLOCK_ITEM.get()))
            .save(this.output, "smoky_quartz_axolotl_statuette_by_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(RoseQuartzList.ROSE_QUARTZ_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, RoseQuartzList.ROSE_QUARTZ_GOLDFISH_STATUETTE_ITEM.get())
            .unlockedBy("has_rose_quartz_block", has(RoseQuartzList.ROSE_QUARTZ_BLOCK_ITEM.get()))
            .save(this.output, "rose_quartz_goldfish_statuette_by_stonecutting");

        SingleItemRecipeBuilder.stonecutting(Ingredient.of(RoseQuartzList.ROSE_QUARTZ_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, RoseQuartzList.ROSE_QUARTZ_CHICKEN_STATUETTE_ITEM.get())
            .unlockedBy("has_rose_quartz_block", has(RoseQuartzList.ROSE_QUARTZ_BLOCK_ITEM.get()))
            .save(this.output, "rose_quartz_chicken_statuette_by_stonecutting");

        SingleItemRecipeBuilder.stonecutting(Ingredient.of(RoseQuartzList.ROSE_QUARTZ_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, RoseQuartzList.ROSE_QUARTZ_BEE_STATUETTE_ITEM.get())
            .unlockedBy("has_rose_quartz_block", has(RoseQuartzList.ROSE_QUARTZ_BLOCK_ITEM.get()))
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(RoseQuartzList.ROSE_QUARTZ_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, RoseQuartzList.ROSE_QUARTZ_AXOLOTL_STATUETTE_ITEM.get())
            .unlockedBy("has_rose_quartz_block", has(RoseQuartzList.ROSE_QUARTZ_BLOCK_ITEM.get()))
            .save(this.output, "rose_quartz_axolotl_statuette_by_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CitrineList.CITRINE_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, CitrineList.CITRINE_GOLDFISH_STATUETTE_ITEM.get())
            .unlockedBy("has_citrine_block", has(CitrineList.CITRINE_BLOCK_ITEM.get()))
            .save(this.output, "citrine_goldfish_statuette_by_stonecutting");

        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CitrineList.CITRINE_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, CitrineList.CITRINE_CHICKEN_STATUETTE_ITEM.get())
            .unlockedBy("has_citrine_block", has(CitrineList.CITRINE_BLOCK_ITEM.get()))
            .save(this.output, "citrine_chicken_statuette_by_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(CitrineList.CITRINE_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, CitrineList.CITRINE_AXOLOTL_STATUETTE_ITEM.get())
            .unlockedBy("has_citrine_block", has(CitrineList.CITRINE_BLOCK_ITEM.get()))
            .save(this.output, "citrine_axolotl_statuette_by_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlueQuartzList.BLUE_QUARTZ_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, BlueQuartzList.BLUE_QUARTZ_GOLDFISH_STATUETTE_ITEM.get())
            .unlockedBy("has_blue_quartz_block", has(BlueQuartzList.BLUE_QUARTZ_BLOCK_ITEM.get()))
            .save(this.output, "blue_quartz_goldfish_statuette_by_stonecutting");

        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlueQuartzList.BLUE_QUARTZ_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, BlueQuartzList.BLUE_QUARTZ_CHICKEN_STATUETTE_ITEM.get())
            .unlockedBy("has_blue_quartz_block", has(BlueQuartzList.BLUE_QUARTZ_BLOCK_ITEM.get()))
            .save(this.output, "blue_quartz_chicken_statuette_by_stonecutting");

        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlueQuartzList.BLUE_QUARTZ_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, BlueQuartzList.BLUE_QUARTZ_BEE_STATUETTE_ITEM.get())
            .unlockedBy("has_blue_quartz_block", has(BlueQuartzList.BLUE_QUARTZ_BLOCK_ITEM.get()))
            .save(this.output, "blue_quartz_bee_statuette_by_stonecutting");

        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlueQuartzList.BLUE_QUARTZ_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, BlueQuartzList.BLUE_QUARTZ_FROG_STATUETTE_ITEM.get())
            .unlockedBy("has_blue_quartz_block", has(BlueQuartzList.BLUE_QUARTZ_BLOCK_ITEM.get()))
            .save(this.output, "blue_quartz_frog_statuette_by_stonecutting");

        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlueQuartzList.BLUE_QUARTZ_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, BlueQuartzList.BLUE_QUARTZ_AXOLOTL_STATUETTE_ITEM.get())
            .unlockedBy("has_blue_quartz_block", has(BlueQuartzList.BLUE_QUARTZ_BLOCK_ITEM.get()))
            .save(this.output, "blue_quartz_axolotl_statuette_by_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(PrasioliteQuartzList.PRASIOLITE_QUARTZ_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, PrasioliteQuartzList.PRASIOLITE_QUARTZ_BEE_STATUETTE_ITEM.get())
            .unlockedBy("has_prasiolite_quartz_block", has(PrasioliteQuartzList.PRASIOLITE_QUARTZ_BLOCK_ITEM.get()))
            .save(this.output, "prasiolite_quartz_bee_statuette_by_stonecutting");

        SingleItemRecipeBuilder.stonecutting(Ingredient.of(PrasioliteQuartzList.PRASIOLITE_QUARTZ_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, PrasioliteQuartzList.PRASIOLITE_QUARTZ_FROG_STATUETTE_ITEM.get())
            .unlockedBy("has_prasiolite_quartz_block", has(PrasioliteQuartzList.PRASIOLITE_QUARTZ_BLOCK_ITEM.get()))
            .save(this.output, "prasiolite_quartz_frog_statuette_by_stonecutting");

        SingleItemRecipeBuilder.stonecutting(Ingredient.of(PrasioliteQuartzList.PRASIOLITE_QUARTZ_BLOCK_ITEM.get()), RecipeCategory.DECORATIONS, PrasioliteQuartzList.PRASIOLITE_QUARTZ_AXOLOTL_STATUETTE_ITEM.get())
            .unlockedBy("has_prasiolite_quartz_block", has(PrasioliteQuartzList.PRASIOLITE_QUARTZ_BLOCK_ITEM.get()))
            .save(this.output, "prasiolite_quartz_axolotl_statuette_by_stonecutting");
    }
